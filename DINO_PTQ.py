...
def detr_sequential(args, model, dataloader, dev):
    ...
    name = f"dino-{args.backbone_model}_gptq{'_transformer' if args.transformer else ''}{'_backbone' if args.backbone else ''}{'_output_head' if args.output_head else ''}{'_query_selection' if args.query_sel else ''}_{args.nsamples}samples_{args.wbits}bits"
